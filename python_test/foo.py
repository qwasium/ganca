...
import unittest
import ganca
from ganca.foo import pyFoo
#import ganca.foo.pyFoo as foo

if __debug__:
    print(f'version: {ganca.__version__}')
    print(f'ganca: ${dir(ganca)}')
    print(f'ganca.foo: ${dir(ganca.foo)}')
