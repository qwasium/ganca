...
class JumpDir():
    '''
    change directory for importing modules and other operations
    ...
    with addPathCd(os.path.join('..', 'paht', 'to', 'lib'), os.path.dirname(os.path.abspath(__file__))):
        module = __import__('mymodule')
